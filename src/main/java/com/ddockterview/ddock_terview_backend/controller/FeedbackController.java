...
public class FeedbackController {
    ...
    public ResponseEntity<GlobalResponseDto> saveFeedback(@RequestBody FeedbackRequestDto requestDto) throws IOException {
        System.out.println(">>> /api/feedback called with JSON body");
